...
def bayes_c(X, y, idx_train, idx_test, normalize_pheno = False, normalize_geno = False, niter=10000, R2 = 0.3):
    r.assign('X',X)
    r.assign('y',y)
...
def train_test(X_train, Y_train, X_test, Y_test, cv_params=None, custom_grid = False):
    ...
    return {}, {}, train_predictions, test_predictions, metrics, "bayes_c"
