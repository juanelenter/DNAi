...
echo "singularity run --nv --cleanenv ~/dnai/scripts/dnai-classic.simg ~/dnai/scripts/noise_all.sh $2 $1 $i ${*:3}"
singularity run --cleanenv ~/dnai/scripts/dnai-latest.simg ~/dnai/scripts/noise_all.sh $2 $1 $i ${*:3}
