...
class GraphFilter_batchnorm(nn.Module):
    """
    ...
    def __init__(self, G, F, K, E = 1, bias = True):
        ...
        self.batch_norm = torch.nn.BatchNorm1d(F, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        # Initialize parameters
        self.reset_parameters()
...
class SpectralGF(nn.Module):
    ...
    def addGSO(self, S):
        ...
        for e in range(self.E):
            ...
            Lambda[e,:], V[e,:,:] = np.linalg.eigh(Snp[e,:,:])
